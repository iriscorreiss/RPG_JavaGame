...
public class Archer extends Hero{
    ...
    /**
     * Construct of the Archer Hero
     * @param nome - name of the Archer Hero
     * @param vida - health of the Archer Hero
     * @param forca - strenght of the Archer Hero
     * @param level - level of the Archer Hero
     * @param gold - coins of the Archer Hero
     */
    public Archer(String nome, int vida, int forca, int level, int gold) {
    ...
    /**
     *
     * @param - method describing a battle between an Archer Hero and an Enemy passed as argument, both subclasses of the Entity class
